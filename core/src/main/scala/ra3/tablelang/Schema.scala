...
object Schema {
  inline def fromIdent[T0<:Tuple](t:TableExpr.Ident[ReturnValueTuple[T0]]) = {
...
class Schema[A <: Tuple](
    val list: Seq[Expr.DelayedIdent[Any]]
) {
  ...
  val none: Expr[ReturnValueTuple[EmptyTuple]] = {
    ra3.lang.Expr
      .BuiltInOpAny(new ra3.lang.ops.OpAnyUnserializable.MkReturnValueTuple[EmptyTuple])(
        Nil
      )
