...
/** This class implements mutable maps with Long keys based on a hash table with
  ...
  */
private[ra3] final class LongMap(
  ...
  private var zeroValue: Int = Int.MinValue
  private var minValue: Int = Int.MinValue
  private var _size = 0
  private var _vacant = 0
  private var _keys: Array[Long] = null
  private var _values: Array[Int] = null
